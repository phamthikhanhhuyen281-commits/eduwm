...
export default function GrammarSection({
  ...
  const handlePageChange = (pageIdx: number) => {
    ...
    if (firstQOfPage) {
      ...
      setTimeout(() => {
        const element = document.getElementById(`grammar-q-${firstQOfPage.id}`);
        if (element) {
  ...
  return (
    <div id="grammar-section-wrapper" className="space-y-6">
      ...
      {/* Paginated Grammar Questions Canvas */}
      <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm space-y-6 w-full">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-100 pb-4">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-base font-black text-slate-800 uppercase">KỸ NĂNG: NGỮ PHÁP (GRAMMAR)</h2>
          </div>
