...
const TRANSLATIONS = {
  vi: {
    ...
    // Student Workspace translations
    sec_listening: 'Nghe (Listening)',
    sec_speaking: 'Nói (Speaking)',
    sec_grammar: 'Ngữ pháp (Grammar)',
    sec_vocabulary: 'Từ vựng (Vocabulary)',
    sec_reading: 'Đọc (Reading)',
    sec_writing: 'Viết (Writing)',
    remaining_time: 'Thời gian còn lại',
    sections_header: 'CHUYỂN PHẦN THI (SECTIONS):',
    candidate_header: 'Thí sinh',
    anti_cheat_warning: 'CẢNH BÁO QUAN TRỌNG:',
    anti_cheat_warning_desc: 'Thí sinh không được sử dụng từ điển, AI, công cụ dịch thuật hoặc nhờ người khác hỗ trợ. Nếu không biết đáp án, hãy bỏ qua.',
    submit_instructions: '* Nhấp "Nộp bài thi" khi đã hoàn thành toàn bộ 6 phần thi đánh giá năng lực.',
    submit_btn: 'NỘP BÀI THI (SUBMIT)',
    exit_room: 'Rời phòng thi',
    confirm_exit_title: 'BẠN CÓ CHẮC CHẮN MUỐN RỜI PHÒNG THI?',
    confirm_exit_desc: 'Toàn bộ kết quả bài làm của bạn sẽ BỊ XOÁ SẠCH và bạn sẽ KHÔNG THỂ thi lại nếu không được giáo viên reset.',
    confirm_submit_title: 'Xác nhận nộp bài',
    confirm_submit_desc: 'Bạn có chắc chắn muốn nộp bài thi? Hành động này không thể hoàn tác.',
    exit_error: 'Lỗi khi rời phòng thi. Vui lòng thử lại.'
  },
  en: {
    // Header & Navigation
    ...
    sec_grammar: 'Grammar',
    sec_vocabulary: 'Vocabulary',
    sec_reading: 'Reading',
    sec_writing: 'Writing',
    remaining_time: 'Remaining Time',
    sections_header: 'SELECT SECTION:',
    candidate_header: 'Candidate',
    anti_cheat_warning: 'CRITICAL WARNING:',
    anti_cheat_warning_desc: 'Candidates must not use dictionaries, AI, translating tools or receive assistance. If you do not know an answer, skip it.',
    submit_instructions: '* Click "Submit Exam" once you have completed all 6 assessment sections.',
    submit_btn: 'SUBMIT EXAM',
    exit_room: 'Exit Room',
    confirm_exit_title: 'ARE YOU SURE YOU WANT TO EXIT?',
    confirm_exit_desc: 'Your active progress will be WIPED OUT and you will NOT be able to retake unless reset by a teacher.',
    confirm_submit_title: 'Confirm Submission',
    confirm_submit_desc: 'Are you sure you want to submit your exam? This action cannot be undone.',
    exit_error: 'Error exiting the exam room. Please try again.'
  }
};
