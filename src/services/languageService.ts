...
const TRANSLATIONS = {
  vi: {
    ...
    sections_header: 'KỸ NĂNG (SKILLS):',
    ...
    submit_instructions: '* Nhấp "Nộp bài thi" khi đã hoàn thành toàn bộ các kỹ năng đánh giá năng lực.',
  ...
  en: {
    ...
    submit_instructions: '* Click "Submit Exam" once you have completed all assessment skills.',
